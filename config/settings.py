...
# SECURITY WARNING: keep the secret key used in production secret! (安全警告：对生产中使用的密钥保密！)
# 生产环境必须改为随机强密钥，可通过 django.core.management.utils.get_random_secret_key() 生成
